...
class EnemyDisplay:
    def __init__(self, ai_settings, screen, y_start):
        ...
        self.aliens = []
        images = [
            image.load('resources/Images/Invader 1-1.png'),
            image.load('resources/Images/Invader 2-1.png'),
            image.load('resources/Images/Invader 3-1.png'),
            image.load('resources/Images/UFO Alien-1.png')
        ]
        for img in images:
